...
//! that maps to [`colophon::Layout`], a `--reference` value that maps to
//! [`colophon::Addressing`], and so on — kept in one module so the argument
...
pub(crate) const CONFIG_STEM: &str = "colophon";
